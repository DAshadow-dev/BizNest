    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            setTimeout(() => {
              // Để đảm bảo Alert không chặn cập nhật trạng thái
              Animated.timing(translateX, {
                toValue: isLocked ? 0 : 20,
                duration: 300,
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={{ margin: 16 }}>
        <View style={styles.card}>
          <Text style={styles.customerName}>An san</Text>
          <Text style={styles.label}>
            Date created: <Text style={styles.value}>21/2/2025</Text>
          </Text>
          <TouchableOpacity
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.label}>
            Email: <Text style={styles.value}>AnNeMayDua@gmail.com</Text>
          </Text>
          <Text style={styles.label}>
            Phone number: <Text style={styles.value}>0945119245</Text>
          </Text>
        </View>
